...
public class DynamicIsland extends HudElement {
    ...
    public void onTick(EventTick e) {
        ...
        Vibe.getInstance().getMediaPlayer().onTick();
    }
    ...
    public void onRender2D(EventRender2D e) {
        ...
        String name = "Vibe";
        String track =  Vibe.getInstance().getMediaPlayer().getLastTitle() + (Vibe.getInstance().getMediaPlayer().getArtist().isEmpty() ? "" : " - " + Vibe.getInstance().getMediaPlayer().getArtist());
        ...
        boolean mediaNull = Vibe.getInstance().getMediaPlayer().fullNullCheck();
        ...
        if (!mediaNull && !isPvp) {
            Render2D.drawTexture(
                    ...
                    height - padding * 2,
                    4f,
                    Vibe.getInstance().getMediaPlayer().getTexture(),

...
import from.Vibe.modules.impl.movement.ElytraBooster;
import from.Vibe.utils.Wrapper;
import from.Vibe.utils.combat.BoostUtils;
...
public abstract class FireworkRocketEntityMixin extends ProjectileEntity implements Wrapper {
    ...
    public Vec3d tick(Vec3d instance, double x, double y, double z) {
        ElytraBooster elytraBooster = Vibe.getInstance().getModuleManager().getModule(ElytraBooster.class);

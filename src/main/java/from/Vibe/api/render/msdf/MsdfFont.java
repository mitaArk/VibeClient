package from.Vibe.api.render.msdf;
...
import from.Vibe.api.render.msdf.FontData.AtlasData;
import from.Vibe.api.render.msdf.FontData.GlyphData;
import from.Vibe.api.render.msdf.FontData.MetricsData;
import from.Vibe.api.render.providers.ResourceProvider;
...
public final class MsdfFont {
	...
	public static class Builder {
		...
		public Builder data(String dataFileName) {
			this.dataIdentifer = Vibe.id("fonts/" + dataFileName + ".json");
			return this;
		}
		
		public Builder atlas(String atlasFileName) {
			this.atlasIdentifier = Vibe.id("fonts/" + atlasFileName + ".png");
			return this;
		}
		
		public MsdfFont build() {
			from.Vibe.api.render.msdf.FontData data = ResourceProvider.fromJsonToInstance(this.dataIdentifer, FontData.class);

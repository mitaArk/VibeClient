...
public class NameTags extends Module {
        ...
        for (Entity entity : mc.world.getEntities()) {
            ...
            if (blur.getValue()) {
                Render2D.drawStyledRect(e.getContext().getMatrices(),
                        ...
                        entity == mc.player || Vibe.getInstance().getFriendManager().isFriend(entity.getName().getString()) ? new Color(0, 255, 255, 150) : new Color(0, 0, 0, 150),
                        255
                );
            } else {
                Render2D.drawRoundedRect(e.getContext().getMatrices(),
                        ...
                        height,
                        rectRounding.getValue(),
                        entity == mc.player || Vibe.getInstance().getFriendManager().isFriend(entity.getName().getString()) ? new Color(0, 255, 255, 150) : new Color(0, 0, 0, 175)
                );
            }
    ...
    private Color getBorderColor(LivingEntity entity) {
        ...
        if (entity == mc.player || Vibe.getInstance().getFriendManager().getFriends().contains(entity.getName().getString())) return new Color(0, 255, 255);

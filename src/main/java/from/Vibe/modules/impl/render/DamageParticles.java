...
import from.Vibe.api.mixins.accessors.IWorldRenderer;
...
public class DamageParticles extends Module {
    ...
    private static class Particle {
        ...
        private Identifier randomTexture() {
            ...
            if (random == 1) return Vibe.id("particles/dollar.png");
            if (random == 2) return Vibe.id("particles/firefly.png");
            if (random == 3) return Vibe.id("particles/snow.png");

            return Vibe.id("particles/star.png");
        }
    }
}